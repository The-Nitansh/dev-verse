...
namespace KafkaProducer.Utilities;
...
public static class JsonHelper
{
    ...
    public static string GetSerializedObject<T>(T obj)
    {
        try { return JsonConvert.SerializeObject(obj); }
        catch (Exception ex) { throw new InvalidOperationException("Failed to serialize object", ex); }
    }
}
